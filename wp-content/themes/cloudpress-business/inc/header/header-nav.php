          ...
          $cloudpress_business_shop_button .= '<div class="nav-search nav-light-search wrap">
            ...
            if ( class_exists( 'WooCommerce' ) ) {
              ...
              if ($woocommerce->cart->cart_contents_count == 0){
                ...
                $cloudpress_business_shop_button .= '<a class="menu-item" href="' . esc_url($cloudpress_business_link) . '" ><span class="cart-total">' . sprintf(_n('%d item', '%d <span>items</span>', $woocommerce->cart->cart_contents_count, 'cloudpress-business'), $woocommerce->cart->cart_contents_count) . '</span></a>';
